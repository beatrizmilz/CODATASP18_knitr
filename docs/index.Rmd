...
subtitle: "2018 CODATA-RDA School of Research Data Science"
author: "[Beatriz Milz](https://beatrizmilz.github.io) - R-Ladies São Paulo"
...
options(htmltools.dir.version = FALSE,  fig.align = 'center', out.width = "100%")
```
...
knitr::include_graphics("imagens/overview.png")
```
...
class:  inverse, center, middle
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("imagens/overview2.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("imagens/chunk.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("imagens/rmd-15-rmd_to_html_fig-1.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("imagens/chunk_load_libraries.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("imagens/chunk_global_options.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("imagens/knit.png")
```
